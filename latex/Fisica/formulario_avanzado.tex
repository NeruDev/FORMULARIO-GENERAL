...
\begin{itemize}
  ...
  \[
    \Delta p(x, t) = -B \frac{\partial s}{\partial x} = \Delta p_{\mathrm{máx}} \sin(kx - \omega t)
  \]
...
\begin{itemize}
  ...
  \[
    \mathbf{S} = \mathbf{V}_{\mathrm{rms}} \mathbf{I}_{\mathrm{rms}}^* = P + j Q = |\mathbf{S}| \cos\theta + j |\mathbf{S}| \sin\theta
  \]
  ...
  \[
    Q = V_{\mathrm{rms}} I_{\mathrm{rms}} \sin(\theta_v - \theta_i) \quad (\text{Potencia Reactiva, VAR})
  \]
...
\begin{itemize}
  ...
  \[
    \mathrm{NA} = \sin(\theta_{\mathrm{máx}}) = \sqrt{n_{\text{núcleo}}^2 - n_{\text{revestimiento}}^2} \approx n_1 \sqrt{2\Delta}
  \]
