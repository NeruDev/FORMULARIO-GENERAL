...
\begin{itemize}
  ...
  \[
    T = 2\pi\sqrt{\frac{m}{k}}
  \]
  \item \textbf{Péndulo Simple (Aproximación para ángulos pequeños $\sin\theta \approx \theta$) (1):}
  \[
    \omega_0 = \sqrt{\frac{g}{L}}
  \]
  \item \textbf{Péndulo Simple (Aproximación para ángulos pequeños $\sin\theta \approx \theta$) (2):}
  \[
    T = 2\pi\sqrt{\frac{L}{g}}
  \]
\end{itemize}
...
\begin{itemize}
  ...
  \[
    d \sin\theta = m \lambda \implies y_{\mathrm{máx}} \approx m \frac{\lambda D}{d} \quad m \in \mathbb{Z}
  \]
  \item \textbf{Experimento de la Doble Rendija de Young (Separación $d$, distancia a pantalla $D \gg d$) (2):}
  \[
    d \sin\theta = \left( m + \frac{1}{2} \right)\lambda \implies y_{\mathrm{mín}} \approx \left( m + \frac{1}{2} \right)\frac{\lambda D}{d} \quad m \in \mathbb{Z}
  \]
