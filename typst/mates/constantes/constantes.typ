...
= 1. Nivel basico: geometria, aritmetica y calculo elemental
  ...
  - *Base del logaritmo natural ($e$):* $lim_(n->oo)(1+1/n)^n=sum_(k=0)^oo1/k!= \  2.71828182845904523536028747135266\ldots$; trascendente.

= 2. Nivel intermedio: analisis, numeros y combinatoria

  - *Euler-Mascheroni ($gamma$):* $lim_(n->oo)(H_n-ln n)=0.57721566490153286060651209008240\ldots$; su irracionalidad aun no esta demostrada.
  - *Catalan ($G$):* $beta(2)=sum_(n=0)^oo(-1)^n/(2n+1)^2=0.91596559417721901505460351493238\ldots$; irracionalidad no resuelta.
  - *Apery ($zeta(3)$):* $sum_(n=1)^oo n^{-3}=1.20205690315959428539973816151144\ldots$; irracional, trascendencia no demostrada.
  - *Liouville ($c$):* $sum_(n=1)^oo 10^{-n!}=0.110001000000000000000001\ldots$; el primer numero trascendente construido explicitamente.
  - *Gompertz ($\delta_G$):* $integral_0^oo e^{-t}/(1+t)\,dt=-eop("Ei")(-1)=0.59634736232319407434107849936927\ldots$.
  ...
  - *Meissel-Mertens ($M$):* $lim_(x->oo)(sum_(p<= x)1/p-lnln x)= \  0.26149721284764278375542683860869\ldots$.
...
= 3. Nivel avanzado: dinamica, algoritmos e informacion
  ...
  - *Conway ($lambda$):* crecimiento de _look-and-say_, $L_n\sim Clambda^n$, \  $1.30357726903429639125709911215255\ldots$; algebraico de grado 71.
  ...
  - *Chaitin ($\Omega_U$):* $sum_(pinop("dom")(U))2^{-|p|}$, dependiente de la maquina universal $U$, no computable y aleatoria algoritmicamente. Un decimal atribuido a una ``maquina estandar'' no es universal y debe citar su construccion concreta.
